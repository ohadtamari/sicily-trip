...
const CAR_RENTAL = {
  ...
  pickup: {
    label: 'איסוף רכב', dayNum: 3, date: '2026-09-19', time: '08:30',
  ...
  return: {
    label: 'החזרת רכב', dayNum: 8, date: '2026-09-24', time: '18:00',
    place: 'Sicily by Car - Palermo Airport',
    address: 'Località Punta Raisi, Cinisi, Italy 90045',
    note: 'להחזיר בשדה - לא במרכז פלרמו, נמנעים מנהיגה/חניה בעיר. החזרה ב-18:00 (ולא 19:00) כדי להספיק להגיע ל-Casa Balarm עד סוף חלון הצ\'ק-אין (19:00) - לוח זמנים צמוד.',
  ...
  reminders: [
    ...
    'יום 24/9: יום נסיעה ארוך (כ-2.5-3 שעות נהיגה) + לוח זמנים צמוד להחזרת הרכב (18:00) וצ\'ק-אין ב-Casa Balarm (עד 19:00) - לא לדחוס עצירות נוספות',
    'יום 27/9: FlixBus הוזמן מראש (הזמנה #338 593 5102) - פלרמו Via Fazello 11:05 ← קטניה שדה תעופה 14:20, מושבים 10C/10D. מרווח ביטחון של כ-3:20 שעות עד הטיסה. צ\'ק-אאוט מ-Casa Balarm עד 10:00 - לשקול לתאם עם המארח דוד השארת מזוודות',
  ],
};
...
const DRIVES = [
  ...
  { fromDay: 8, from: 'שדה פלרמו', to: 'Casa Balarm (קסטלמארה)', duration: '~40-45 דק\' (רכבת/אוטובוס) - למהר, החלון נסגר ב-19:00', toLat: 38.1212, toLng: 13.3698 },
  ...
  { fromDay: 11, from: 'פלרמו (Via Fazello)', to: 'קטניה שדה תעופה', duration: '~3:15 שעות (FlixBus 582)', toLat: 37.4668, toLng: 15.0664 },
];
