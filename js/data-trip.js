...
const TRIP_DAYS = [
  ...
  },
  {
    ...
    items: [
      { time: '10:30', title: 'לה פשקריה - שוק הדגים', desc: 'עדיין פעיל גם לא בשיא הבוקר (07:00-09:00)', icon: '🐟', lat: 37.5024, lng: 15.0873 },
      { time: '12:20', title: 'פיאצה דל דואומו + מזרקת הפיל', desc: 'סמל העיר', icon: '⛲', lat: 37.5023, lng: 15.0872 },
      ...
      { time: '16:00', title: 'ויה אטנאה', desc: 'הרחוב הראשי, קניות ואווירה', icon: '🛍️', lat: 37.5064, lng: 15.0876 },
      { time: '17:30', title: 'וילה בליני', desc: 'גנים יפים, לקראת שקיעה (~19:15)', icon: '🌳', lat: 37.5096, lng: 15.0916 },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '11:20', title: 'אורטיג\'יה', desc: 'האי ההיסטורי הקטן: פיאצה דואומו, מזרקת ארתוזה, שוק בוקר (עדיין פעיל בשבת), מסעדות דגים - כ-3 שעות הליכה רגועה', icon: '🏛️', base: 'ortigia', lat: 37.0587, lng: 15.2933 },
      ...
      { time: '16:35', title: 'נוטו', desc: 'רחוב ראשי בארוקי מרשים - במיוחד יפה עם אור אחר הצהריים/שקיעה, כ-3 שעות', icon: '🏛️', base: 'noto', lat: 36.8909, lng: 15.0709 },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '18:30', title: 'קורסו אומברטו', desc: 'הרחוב הראשי', icon: '🚶', base: 'taormina', lat: 37.8528, lng: 15.2894 },
      { time: '19:00', title: 'פיאצה IX אפריל', desc: 'שקיעה עם נוף לים ולאטנה (~19:15)', icon: '🌅', base: 'taormina', lat: 37.8534, lng: 15.2889 },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { time: '09:35', title: 'גולה דל אלקנטרה', desc: 'Gole dell\'Alcantara - קניון בזלת דרמטי, מדרכה לאורך הקניון ומדרגות/מעלית לנחל. סטייה מכוונת מהדרך הישירה ליקב - כ-2 שעות', icon: '🏞️', base: 'alcantara', lat: 37.8804, lng: 15.1734 },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '09:40', title: 'רכבל + ג\'יפ עם מדריך', desc: 'Funivia dell\'Etna עד 2,500 מ\', המשך בג\'יפ 4X4 עד ~2,800-3,000 מ\' עם מדריך (כ-60 יורו, לבדוק מחיר מעודכן). הליכה קלה סביב המכתשים - כ-2.75 שעות בסך הכל', icon: '🚡', base: 'etna', lat: 37.7000, lng: 14.9958 },
  ...
  },
  {
    ...
    items: [
      { time: '09:00', title: 'שוק באלארו', desc: 'הכי תוסס בבוקר מוקדם', icon: '🛒', base: 'palermo', lat: 38.1113, lng: 13.3572 },
      { time: '11:00', title: 'שוק ווצ\'יריה', desc: 'סמוך לבאלארו - אפשר לשלב עם ארוחת ביניים/סטריט פוד', icon: '🛒', base: 'palermo', lat: 38.1194, lng: 13.3617 },
      { time: '12:30', title: 'קפלה פלטינה', desc: 'Cappella Palatina - פסיפסים ביזנטיים-נורמניים מדהימים. כדאי לבדוק שעות פתיחה מראש, לפעמים סגורה בצהריים', icon: '🕌', base: 'palermo', lat: 38.1113, lng: 13.3532 },
      ...
      { time: '20:00', title: 'אזור קלסה / ווצ\'יריה', desc: 'מרכז חיי הלילה של פלרמו, כולל הסצנה הגאה (EXIT10&LOVE ועוד)', icon: '🍹', base: 'palermo' },
    ],
  },
  {
    ...
    items: [
      ...
      { time: '08:45', title: 'צ\'פאלו', desc: 'קתדרלה נורמנית, חוף, טיילת, ואפשר הליכה לצוק (La Rocca) - כ-4.25 שעות', icon: '🏖️', base: 'cefalu', lat: 38.0400, lng: 14.0231 },
      ...
      { time: '15:30', title: 'קתדרלת מונריאלה', desc: 'פסיפסים ביזנטיים-נורמניים - כ-2 שעות', icon: '⛪', base: 'monreale', lat: 38.0819, lng: 13.2903 },
