...
const TRIP_DAYS = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: '19:00', title: 'Sparkling Wine Experience', desc: 'טעימות יין מבעבע + קרש נקניקים/גבינות, במקום הלינה', icon: '🍷', base: 'santavenerina', booking: { name: 'Sparkling Wine Experience', status: 'pending', time: 'סביב 19:00' } },
    ],
    foodNote: { lunch: 'צהריים - על הדרך', dinner: 'ערב - יש הזמנה בהמתנה לאישור שעה (Sparkling Wine Experience ביקב)' },
  },
  {
    ...
    items: [
      ...
      { time: '19:00', title: 'Food and Wine Experience', desc: '5 יינות - ערב אחרון ביקב, ב-Tenuta San Michele', icon: '🍷', base: 'santavenerina', booking: { name: 'Food and Wine Experience', status: 'pending', time: 'סביב 19:00' } },
    ],
    foodNote: { lunch: 'צהריים - על הדרך', dinner: 'ערב - יש הזמנה בהמתנה לאישור שעה (Food and Wine Experience ביקב)' },
  },
  {
